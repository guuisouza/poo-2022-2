...
public class Assistente extends Funcionario {
    ...
    public Assistente(float horasExtras, String quemAssiste, int codigo, String nome, String cpf, float salario, float cargaHoraria) {
    ...
    public String toString() {
        return "Assistente{"+ "horasExtras=" + horasExtras + ", quemAssiste=" + quemAssiste + super.toString() + '}';
    }  
}
