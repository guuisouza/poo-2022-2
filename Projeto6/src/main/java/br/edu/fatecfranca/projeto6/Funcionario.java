...
ela serve apenas de modelo para as classes filhas, promovendo reutilização de código
ela pode ter também metodos abstratos
esses metodos abstratos OBRIGATORIAMENTE tem que estar contido nas classes filhas
*/
public abstract class Funcionario {
    ...
    public String toString() {
        return "Funcionario{" + "codigo=" + codigo + ", nome=" + nome + ", cpf=" 
                + cpf + ", salario=" + salario + ", cargaHoraria=" + cargaHoraria + '}';
    }
